<template>
    <header class="header">
      ...
      <div class="navbar">
        ...
        <div class="navbar-right-container" style="display: flex;">
          <div class="navbar-menu-container">
            <span class="navbar-link">{{loginName}}</span>
            <a @click="loginModalShow=true" v-if="!loginName" class="navbar-link">Login</a>
            <a @click="logout" v-if="loginName" class="navbar-link">Logout</a>
      ...
      <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':loginModalShow}">
        <div class="md-modal-inner">
          <div class="md-top">
            ...
            <button class="md-close" @click="loginModalShow=false">Close</button>
          </div>
          <div class="md-content">
            <div class="confirm-tips">
              <div class="error-wrap">
                <span class="error error-show" v-show="errorTipShow">用户名或者密码错误</span>
              </div>
              <ul>
                <li class="regi_form_input">
                  <i class="icon IconPeople"></i>
                  <input v-focus type="text" tabindex="1" name="loginname" v-model="userName" class="regi_login_input regi_login_input_left" placeholder="User Name" data-type="loginname">
                </li>
      ...
      <div class="md-overlay" v-if="loginModalShow" @click="loginModalShow=false"></div>
    </header>
</template>
<style>
    .header {
  ...
  export default {
    ...
    methods:{
        ...
        setVuex(cartCount){
            ...
            this.$store.commit('setCartCount', cartCount | 0);
        }
    }
  }
</script>
